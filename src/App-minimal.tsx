    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        <Routes>
          ...
          <Route path="/crm" element={isLoggedIn ? <div>CRM - En construction</div> : <Login onLogin={handleLogin} />} />
          <Route path="/dashboard" element={isLoggedIn ? <div>Dashboard - En construction</div> : <Login onLogin={handleLogin} />} />
        </Routes>
      </main>
    </div>
  );
